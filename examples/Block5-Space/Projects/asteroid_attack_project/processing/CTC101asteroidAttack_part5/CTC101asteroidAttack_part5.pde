 ...
 *
 * Step 5:
 *  - We add a third class, for our asteroids
 *  - Similar to the previous classes, we declare an array
 *  - We add collision detection, similar to'Catch the apple' in Block 1
 *
