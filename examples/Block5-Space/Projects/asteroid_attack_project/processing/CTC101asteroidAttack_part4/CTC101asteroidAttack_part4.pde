 ...
 *
 * Step 4:
 *  - Create a class called Shot
 *  - Just like in step 3, we create an array of Shots
 *  - Make the application create a new shot once the button is pressed
 *  - We use the Time class to create an interval for the shots
 *
